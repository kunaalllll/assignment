...
class Atri:
	def __init__(self, state: Any):
		...
		self.Nav-container = state["Nav-container"]
	...
	@property
	def Nav-container(self):
		self._getter_access_tracker["Nav-container"] = {}
		return self._Nav-container
	@Nav-container.setter
	def Nav-container(self, new_state):
		self._setter_access_tracker["Nav-container"] = {}
		global default_state
		self._Nav-container = Flex(new_state, default_state["Nav-container"])
	...
	def _to_json_fields(self):
		return {
			"Nav-container": self._Nav-container,
			"Flex9": self._Flex9,
			"Flex10": self._Flex10,
			"Link2": self._Link2,
			"Link3": self._Link3,
